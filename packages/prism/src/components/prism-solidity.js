...
import './prism-clike'
Prism.languages.solidity = Prism.languageUtils.extend('clike', {
  'class-name': {
...
Prism.languageUtils.insertBefore('solidity', 'keyword', {
...
Prism.languageUtils.insertBefore('solidity', 'number', {
  version: {
    pattern: /([<>]=?|\^)\d+\.\d+\.\d+\b/,
    lookbehind: true,
    alias: 'number',
